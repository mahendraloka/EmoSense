...
>
    ...
    {{-- Footer Sidebar --}}
    <div class="p-4 border-t border-gray-800 flex-shrink-0 bg-[#0F172A]">
        <form action="{{ route('admin.logout') }}" method="POST">
            @csrf
            <button class="w-full flex items-center justify-center gap-2 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white py-3 rounded-xl transition-all font-semibold active:scale-95">
                🚪 Logout
            </button>
        </form>
    </div>
