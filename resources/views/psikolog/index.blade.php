    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
        ...
        <div class="group relative bg-white/70 backdrop-blur-xl rounded-[2.5rem] p-8 text-center border border-white shadow-xl shadow-slate-200/50 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl overflow-hidden">
            ...
            <div class="mt-8 relative z-10">
                ...
                target="_blank"
                class="inline-flex items-center justify-center gap-3 w-full rounded-2xl px-6 py-4 bg-slate-900 text-white text-[11px] md:text-xs font-black uppercase tracking-[0.15em] shadow-xl shadow-sky-200/50 hover:bg-emerald-500 hover:shadow-emerald-200 transition-all duration-300 active:scale-95 group/btn">
                
                {{-- Animasi Ring pada Icon agar lebih hidup --}}
                <div class="relative">
                    <span class="absolute inset-0 bg-white rounded-full animate-ping opacity-20 group-hover/btn:hidden"></span>
